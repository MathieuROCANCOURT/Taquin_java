...
public class Plateau extends AbstractPlateau {
    ...
    //Cr�e les pieces du Taquin et les place dans l'arrayList
    ...
    public void moveLeft() {
        ...
        if (this.plateau.get(i / colonnes).get(i % colonnes).getColonne() != 1) { //Vérifie s'il existe une case à gauche

            this.plateau.get(i / colonnes).get(i % colonnes).setColonne(-1);    //Échange les coordonnées
            this.plateau.get(i / colonnes).get(i % colonnes - 1).setColonne(+1);

            Piece tmp = this.plateau.get(i / colonnes).get(i % colonnes);    //Échange les places des 2 pieces dans l'arrayList
    ...
    //***********************************************************//
    public boolean res() { //Vérifie si chaque piece est à sa place
